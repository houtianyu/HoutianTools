...
class MainGui:
    ...
    def oneGui(self):
        ...
        for value in self.frame_v:
            ...
            value[2] = Frame(self.root,height=30,relief="ridge", bd=1,width=670,bg='SkyBlue').grid(padx=1,row=value[0],column=0,columnspan=8,sticky=W)
        #百度
        ...
        Button(self.frame_v[0][2],text="百度一下",state='normal',width=10,bg='LightGreen',command=lambda:self.otherJob.thread_add(self.functioncall.BaiduSearch)).\
        ...
        Label(self.frame_v[1][2], text="eg: D:/Python/test.txt",bg='LightYellow',justify = LEFT).grid(padx=5, row=1, column=4, columnspan=3,sticky=W)
        Button(self.frame_v[1][2],text="打开",state='normal',width=10,bg='LightGreen',command=lambda:self.otherJob.thread_add(self.functioncall.OpenFiles)).\
        ...
        Button(self.frame_v[2][2],text="本地搜索",state='normal',width=10,bg='LightGreen',command=lambda:self.otherJob.thread_add(self.functioncall.SearchFiles)).\
        ...
        Button(self.frame_v[3][2], text="开始登陆", state='normal', width=10,bg='LightGreen',command=lambda: self.otherJob.thread_add(self.functioncall.LoginWechat)). \
        ...
        Button(self.frame_v[4][2], text="播放", state='normal', width=10,bg='LightGreen',command=lambda: self.otherJob.thread_add(self.functioncall.PlayMusic)). \
        ...
        Button(self.frame_v[5][2], text="开始清理", state='normal', width=10,bg='LightGreen',command=lambda: self.otherJob.thread_add(self.functioncall.Garbage_Clear)). \
        ...
        Label(self.frame_v[6][2], text="密码:", width=4,bg='LightYellow',justify = LEFT).grid(padx=1,row=6, column=2, sticky=W)
        ...
        member.grid(padx=5,row=6, column=4, sticky=W)
        ...
        Button(self.frame_v[6][2], text="登录", state='normal', width=10,bg='LightGreen',command=lambda: self.otherJob.thread_add(self.functioncall.LoginEmail)). \
        ...
        Button(self.frame_v[7][2], text="启动监控", state='normal', width=10,bg='LightGreen',command=lambda: self.otherJob.thread_add(self.functioncall.Up_Monitor)). \
        ...
        Button(self.frame_v[8][2],text='打开网站',state='normal',width=10,bg='LightGreen',command=lambda:self.otherJob.thread_add(self.functioncall.Open_Websit)).\
            grid(padx=5,row=8,column=7,sticky=W)
        #
        mainloop()
